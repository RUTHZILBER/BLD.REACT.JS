...
export default withRouter(connect(mapStateToProps)(function UpdateAccount(props) {
  const { dispatch, history, userId, userName, firstName, lastName, email, password } = props;
  ...
  //עדכון הלקוח
  function updateUser() {
    fetch("http://localhost:62135/api/values/updateUsr?", {
      method: "post",
  ...
  //EROR PROVIDER
  const [textColor, setTextColor] = useState("classes.cssLabel");
  ...
  //before sending to webapi, submit
            ...
            <div>
              ...
              <div>
                ...
                <div className={classes.buttons}>
                  ...
                  >
                    ...סימתי לעדכן את הפרטים החדשים שלי
                </Button>
                </div>
              </div>
